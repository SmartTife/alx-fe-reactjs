  ...
  return (
    <div className="bg-gray-100 sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm mx-auto, my-20 rounded-lg shadow-lg">
      <img src="https://via.placeholder.com/150"
       alt="User"
       className="sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto rounded-full hover:scale-110 
                  transition-transform duration-300 ease-in-out hover:text-blue-500 hover:shadow-xl)."  
     />
